...
def test_instance_delete_raises_protected_error_with_no_objects_when_unsaved() -> None:
    parent = _build_parent(pk=None)
...
def test_instance_delete_reports_the_archived_persisted_instance() -> None:
    parent = _build_parent(pk=1)
    parent.archived = True
